                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group {{$errors->has('session') ? 'has-error' : ''}}">
                            ...
                            <input value="{{old('session')}}" type="text" name="session" class="form-control" placeholder="সেশন">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group {{$errors->has('start_date') ? 'has-error' : ''}}">
                            ...
                            <input value="{{old('start_date')}}" class="form-control date" type="text" name="start_date" id="start_date" placeholder="শুরুর তারিখ " autocomplete="off">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group {{$errors->has('end_date') ? 'has-error' : ''}}">
                            ...
                            <input value="{{old('end_date')}}" class="form-control date1" type="text" name="end_date" id="end_date" placeholder="শেষের তারিখ "  autocomplete="off">
                ...
                <div class="row">
                        <div class="col-sm-6 {{$errors->has('type') ? 'has-error' : ''}}">
                            <div class="form-group">
                                <label class="" for="type">টাইপ </label>
                                <div class="">
                                    <select class="form-control" name="type" id="type" >
                                        <option value=""> নির্বাচন করুন</option>
                                        <option value="1">উচ্চ মাধ্যমিক</option>
                                        <option value="2">কলেজ</option>
