...
@section('content')
    <div class="panel col-md-12" style="margin-top: 15px; margin-bottom: 15px;">
        ...
        <div class="panel-body">
            @if (isset($student))
            <form action="{{url('testimonial/edit',$student->id)}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('upazila') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('upazila',$student->upazila)}}" class="form-control" type="text" name="upazila" id="upazila" placeholder="upazila" data-validation="required length" data-validation-length="max100">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('exam_session') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('exam_session',$student->exam_session)}}" class="form-control" type="text" name="exam_session" id="exam_session" placeholder="Exam Year" data-validation="required length" data-validation-length="max100" >
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('gpa') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('gpa',$student->gpa)}}" class="form-control" type="text" name="gpa" id="gpa" placeholder="G.P.A" data-validation="required length" data-validation-length="max100">
                            </div>
                            @if ($errors->has('gpa'))
                                <span class="help-block">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('roll') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('roll',$student->roll)}}" class="form-control" type="text" name="roll" id="roll" placeholder="Exam Roll" data-validation="required length" data-validation-length="max100">
                            </div>
                            @if ($errors->has('roll'))
                                <span class="help-block">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('board') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('board',$student->board)}}" class="form-control" type="text" name="board" id="board" placeholder="Board" data-validation="required length" data-validation-length="max100">
                            </div>
                            @if ($errors->has('board'))
                                <span class="help-block">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('session') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('session',$student->session)}}" class="form-control" type="text" name="session" id="session" placeholder="Session" data-validation="required length" data-validation-length="max100">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('exam') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('exam',$student->exam)}}" class="form-control" type="text" name="exam" id="exam" placeholder="Exam Type" data-validation="required length" data-validation-length="max100">
                            </div>
                            @if ($errors->has('exam'))
                                <span class="help-block">
