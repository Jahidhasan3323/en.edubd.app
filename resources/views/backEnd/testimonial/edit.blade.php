                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('exam_session') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('exam_session',$student->exam_session)}}" class="form-control" type="text" name="exam_session" id="exam_session" placeholder="পরীক্ষার সাল" data-validation="required length" data-validation-length="max100" >
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('gpa') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('gpa',$student->gpa)}}" class="form-control" type="text" name="gpa" id="gpa" placeholder="প্রাপ্ত জিপিএ " data-validation="required length" data-validation-length="max100">
                            </div>
                            @if ($errors->has('gpa'))
                                <span class="help-block">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('roll') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('roll',$student->roll)}}" class="form-control" type="text" name="roll" id="roll" placeholder="পরীক্ষার রোল নম্বর" data-validation="required length" data-validation-length="max100">
                            </div>
                            @if ($errors->has('roll'))
                                <span class="help-block">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('board') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('board',$student->board)}}" class="form-control" type="text" name="board" id="board" placeholder="শিক্ষা বোর্ড" data-validation="required length" data-validation-length="max100">
                            </div>
                            @if ($errors->has('board'))
                                <span class="help-block">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('session') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('session',$student->session)}}" class="form-control" type="text" name="session" id="session" placeholder="শিক্ষাবর্ষ" data-validation="required length" data-validation-length="max100">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('exam') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('exam',$student->exam)}}" class="form-control" type="text" name="exam" id="exam" placeholder="পরীক্ষার ধরণ" data-validation="required length" data-validation-length="max100">
                            </div>
                            @if ($errors->has('exam'))
                                <span class="help-block">
