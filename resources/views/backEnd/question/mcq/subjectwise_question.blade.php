                    ...
                    @foreach($questions as $question)
                        <tr>
                            ...
                            <td>
                                ...
                                <a style="margin-bottom: 10px;" href="{{url('/mcq/question/edit/'.$question->id)}}" class="btn btn-success"><span class="glyphicon glyphicon-pencil"></span></a>

                                <a style="margin-bottom: 10px" href=""  onclick="event.preventDefault(); clickFunction{{$question->id}}()"
                                       class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span>
                                    </a>
                                <form style="display: none;" id="delete-form{{$question->id}}" method="post" action="{{url('mcq/question/delete/'.$question->id)}}" style="padding: 0; margin: 0; outline: 0;">
                                    {{method_field('delete')}}
                                    {{csrf_field()}}
                                </form>
                                <script>
