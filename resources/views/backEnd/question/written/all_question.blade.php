                ...
                @if(isset($questions))
                    ...
                    @foreach($questions as $question)
                        <tr>
                            ...
                            <td>
                              <a style="margin-bottom: 10px;" href="{{url('/written/question/all/subjectwise/'.$question->subject_id)}}" class="btn btn-info"><span class="glyphicon glyphicon-eye-open"></span></a>
