...
@section('mainTitle', 'ভিজিটর যোগ করুন')
...
@section('content')
    <div class="panel col-sm-12" style="margin-top: 15px; margin-bottom: 15px;">
        <div class="page-header">
            <h1 class="text-center text-temp">ভিজিটর যোগ করুন</h1>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group {{$errors->has('name') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('name')}}" class="form-control" type="text" name="name" id="name" placeholder="ভিজিটরের নাম লিখুন">
                            </div>
                            @if ($errors->has('name'))
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('mobile') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('mobile')}}" class="form-control" type="number" name="mobile" id="mobile" placeholder="ভিজিটরের মোবাইল নাম্বার লিখুন">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('subject') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('designation')}}" class="form-control" type="text" name="designation" id="designation" placeholder="ভিজিটরের পদবী লিখুন">
                            </div>
