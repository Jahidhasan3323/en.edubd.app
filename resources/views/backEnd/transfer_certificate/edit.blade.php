                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('name') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('name',$student->name)}}" class="form-control" type="text" name="name" id="name" placeholder="শিক্ষার্থীর নাম" data-validation="required length" data-validation-length="max100">
                            </div>
                            @if ($errors->has('name'))
                                <span class="help-block">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('village') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('village',$student->village)}}" class="form-control" type="text" name="village" id="village" placeholder="গ্রাম" data-validation="required length" data-validation-length="max100">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('post_office') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('post_office',$student->post_office)}}" class="form-control" type="text" name="post_office" id="post_office" placeholder="ডাকঘর" data-validation="required length" data-validation-length="max100">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('upazila') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('upazila',$student->upazila)}}" class="form-control" type="text" name="upazila" id="upazila" placeholder="থানা" data-validation="required length" data-validation-length="max100">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('district') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('district',$student->district)}}" class="form-control" type="text" name="district" id="district" placeholder="জেলা" data-validation="required length" data-validation-length="max100">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('reg_no') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('reg_no',$student->reg_no)}}" class="form-control" type="text" name="reg_no" id="reg_no" placeholder="রেজিস্ট্রেশন নম্বর" data-validation="required length" data-validation-length="max100">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('from_session') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('from_session',$student->from_session)}}" class="form-control" type="text" name="from_session" id="from_session" placeholder="শুরুর শিক্ষাবর্ষ" data-validation="required length" data-validation-length="max100">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('to_session') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('to_session',$student->to_session)}}" class="form-control" type="text" name="to_session" id="to_session" placeholder="শেষ শিক্ষাবর্ষ" data-validation="required length" data-validation-length="max100">
                            </div>
                    ...
                    <div class="col-md-6">
                          <div class="form-group {{$errors->has('birth_day') ? 'has-error' : ''}}">
                              ...
                              <div class="">
                                  <input value="{{old('birth_day',$student->birth_day)}}" class="form-control date" type="text" name="birth_day" id="birth_day" placeholder="জন্ম তারিখ" data-validation="required length" data-validation-length="max100">
                              </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('from_pay_session') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('from_pay_session',$student->from_pay_session)}}" class="form-control " type="text" name="from_pay_session" id="from_pay_session" placeholder="বেতন/ফি পরিষদ শুরুর তারিখ" data-validation="required length" data-validation-length="max100">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('to_pay_session') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('to_pay_session',$student->to_pay_session)}}" class="form-control " type="text" name="to_pay_session" id="to_pay_session" placeholder="বেতন/ফি পরিষদ শুরুর তারিখ" data-validation="required length" data-validation-length="max100">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('tc_cause') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('tc_cause',$student->tc_cause)}}" class="form-control" type="text" name="tc_cause" id="tc_cause" placeholder="বিদ্যালয় পরিত্যাগের কারণ" data-validation="required length" data-validation-length="max100">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('is_pass') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('is_pass',$student->is_pass)}}" class="form-control" type="text" name="is_pass" id="is_pass" placeholder="হয়েছে/হয়নাই" data-validation="required length" data-validation-length="max100">
                            </div>
                    ...
                    <div class="col-md-6">
                          <div class="form-group {{$errors->has('leave_date') ? 'has-error' : ''}}">
                              ...
                              <div class="">
                                  <input value="{{old('leave_date',$student->leave_date)}}" class="form-control date" type="text" name="leave_date" id="leave_date" placeholder="বিদ্যালয় পরিত্যাগের তারিখ" data-validation="required length" data-validation-length="max100">
                              </div>
