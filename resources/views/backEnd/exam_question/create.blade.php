                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('name') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('name')}}" class="form-control" type="text" name="name" id="name" placeholder="পরীক্ষা্র নাম" data-validation="required length" data-validation-length="max100">
                            </div>
                            @if ($errors->has('name'))
                    ...
                    <div class="col-sm-6">
                          <div class="form-group {{$errors->has('time') ? 'has-error' : ''}}">
                              ...
                              <div class="">
                                  <input value="{{old('time')}}" class="form-control" type="text" name="time" id="time" placeholder="সময়" data-validation="required length number" data-validation-length="max10">
                              </div>
                              @if ($errors->has('time'))
                                  <span class="help-block">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group {{$errors->has('full_mark') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('full_mark')}}" class="form-control" type="text" name="full_mark" id="full_mark" placeholder="পূর্ণমান" data-validation="required length number" data-validation-length="max100" data-validation-allowing="float">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('pass_mark') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('pass_mark')}}" class="form-control" type="text" name="pass_mark" id="pass_mark" placeholder="পাস মার্ক" data-validation="required length number" data-validation-length="max100" data-validation-allowing="float">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('shift') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('shift')}}" class="form-control" type="text" name="shift" id="shift" placeholder="শিফট" data-validation="required length" data-validation-length="max100">
                            </div>
                            @if ($errors->has('shift'))
                                <span class="help-block">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('section') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('section')}}" class="form-control" type="text" name="section" id="section" placeholder="শাখা" data-validation="required length" data-validation-length="max100" name="section">
                            </div>
