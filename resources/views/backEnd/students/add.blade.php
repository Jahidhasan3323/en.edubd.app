...
<div class="panel col-sm-12" style="margin-top: 15px; margin-bottom: 15px;">
    ...
    @isset($classes)
        <div class="panel-body">
            <form name="validate" class="validate" action="{{ route('student.store') }}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group {{$errors->has('roll') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('roll')}}" type="number" class="form-control" name="roll" id="roll" placeholder="Student Class Roll">
                            </div>
                            @if ($errors->has('roll'))
                            <span class="help-block">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group {{$errors->has('birthday') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('birthday',date('d-m-Y',strtotime('-15 years')))}}" class="form-control date" type="text" name="birthday" id="birthday" placeholder="Birth Day">
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group {{$errors->has('birth_rg_no') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('birth_rg_no','No information')}}" class="form-control" type="text" name="birth_rg_no" id="birth_rg_no" placeholder="Student Birth Registration No">
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group {{$errors->has('mobile') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('mobile')}}" class="form-control" type="number" name="mobile" id="mobile" placeholder="Student Contact">
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('pre_vpm') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('pre_vpm','No data')}}" type="text" class="form-control" name="pre_vpm" id="pre_vpm" placeholder="Student Village / Para / Mahalla">
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('pre_poff') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('pre_poff','No data')}}" type="text" class="form-control" name="pre_poff" id="pre_poff" placeholder="Student Post office">
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('pre_unim') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('pre_unim','No data')}}" type="text" class="form-control" name="pre_unim" id="pre_unim" placeholder="Student Union / Municipality">
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('pre_subd') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('pre_subd','No data')}}" type="text" class="form-control" name="pre_subd" id="pre_subd" placeholder="Student Sub District / Thana">
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('pre_district') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('pre_district','No data')}}" type="text" class="form-control" name="pre_district" id="pre_district" placeholder="Student District">
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group{{ $errors->has('pre_postc') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{ old('pre_postc','No data') }}" type="number" class="form-control" name="pre_postc" id="pre_postc" placeholder="Student Post Code">
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('per_postc') ? 'has-error' : ''}}">
                            ...
                            <div>
                                <input value="{{old('per_postc')}}" type="number" class="form-control" name="per_postc" id="per_postc" placeholder="Student Post Code">
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group {{$errors->has('father_name') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('father_name','No data')}}" class="form-control" type="text" name="father_name" id="father_name" placeholder="Student Fater name">
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('f_career') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('f_career','No data')}}" class="form-control" type="text" name="f_career" id="f_career" placeholder="Student Father Career">
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-6 {{$errors->has('f_mobile_no') ? 'has-error' : ''}}">
                        <div class="form-group">
                            ...
                            <div class="">
                                <input value="{{old('f_mobile_no')}}" class="form-control" type="number" name="f_mobile_no" id="f_mobile_no" placeholder=" Father Mobile">
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group {{$errors->has('mother_name') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('mother_name','No data')}}" class="form-control" type="text" name="mother_name" id="mother_name" placeholder="Student Mother Name">
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('m_career') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('m_career','No data')}}" class="form-control" type="text" name="m_career" id="m_career" placeholder="Mother Career">
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-6 {{$errors->has('m_mobile_no') ? 'has-error' : ''}}">
                        <div class="form-group">
                            ...
                            <div class="">
                                <input value="{{old('m_mobile_no')}}" class="form-control" type="number" name="m_mobile_no" id="m_mobile_no" placeholder=" Father Mobile">
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group {{$errors->has('f_nid') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('guardian_mobile')}}" class="form-control" type="number" name="guardian_mobile" id="guardian_mobile" placeholder="Guardian Mobile">
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('f_photo') ? 'has-error' : ''}}">
                            <label for="f_photo">Father's Name </label>
