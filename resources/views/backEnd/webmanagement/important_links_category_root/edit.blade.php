                ...
                <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group {{$errors->has('tittle') ? 'has-error' : ''}}">
                          ...
                          <input type="text" name="tittle" class="form-control" placeholder="Title" data-validation="required length " data-validation-length="max100" value="{{$important_links_category_root->tittle}}">
