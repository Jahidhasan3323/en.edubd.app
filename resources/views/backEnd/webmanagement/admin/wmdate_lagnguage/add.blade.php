...
@section('mainTitle', 'Add Language Date')
...
@section('content')
    <div class="panel col-sm-12" style="margin-top: 15px; margin-bottom: 15px;">
        ...
        <div class="panel-body">
            <form action="{{url('/date_language/create')}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="row">
    ...
    <script type="text/javascript">
        document.getElementById('date_language_id').value="{{old('date_language_id')}}";
    </script>
    @endif
@endsection
