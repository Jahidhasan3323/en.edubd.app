...
<div class="page-header text-center">
    <h3>{{$student->user->name.' এর প্রগ্রেস রিপোর্ট কার্ড '}}</h3>
</div>
                    ...
                    <table class="table table-bordered table-hover table-striped text-center">
                        ...
                        <tbody>
                          ...
                          @endforeach
                            ...
                            <p style="padding: 0;margin:0">মোট নম্বর : {{$results[0]['grand_total_mark']}}, প্রাপ্ত জিপিএ : {{$fainal_gpa}}, শ্রেণী অবস্থান : 
                            @php
