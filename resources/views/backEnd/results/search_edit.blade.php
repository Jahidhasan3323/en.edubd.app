...
@section('content')
    <div class="panel col-sm-12" style="margin-top: 15px; margin-bottom: 15px;">
        ...
        <div class="panel-body">
            <form id="result_from" action="{{url('/result/search-edit')}}" method="get" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="row">
                    <div class="row">
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group {{$errors->has('student_id') ? 'has-error' : ''}}">
                                <label class="" for="teacher_id"> Stukdent ID <span class="star">*</span></label>
                                <div class="">
...
@if(session()->get('data_check'))
 <script>
     var exam_year="{{session()->get('data_check')['exam_year']}}";
     var exam_type_id="{{session()->get('data_check')['exam_type_id']}}";
     var student_id="{{session()->get('data_check')['student_id']}}";
     $("#exam_year").val(exam_year);
     $("#exam_type_id").val(exam_type_id);
     $("#student_id").val(student_id);
 </script>
@endif
@php(session()->put('data_check',[]))
@endsection
