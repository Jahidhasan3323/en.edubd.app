...
@section('content')
    <div class="panel col-sm-12" style="margin-top: 15px; margin-bottom: 15px;">
        <div class="page-header">
            <h1 class="text-center text-temp">View the results of a class</h1>
        </div>
        ...
        <div class="panel-body">
            <form id="result_from" action="{{url('/result/get-class-result')}}" method="get" enctype="multipart/form-data" target="_blank">
                {{csrf_field()}}
