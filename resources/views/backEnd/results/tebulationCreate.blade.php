...
@section('content')
    <div class="panel col-sm-12" style="margin-top: 15px; margin-bottom: 15px;">
        <div class="page-header">
            <h1 class="text-center text-temp">Create class based tabulation sheet</h1>
        </div>
        ...
        <div class="panel-body">
            <form id="result_from" action="{{url('/result/get-tebulation-sheet')}}" method="get" enctype="multipart/form-data" target="_blank">
                {{csrf_field()}}
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group {{$errors->has('roll_serialize') ? 'has-error' : ''}}">
                            <div class="">
                                <label class="checkbox-inline" for="roll_serialize"><input type="checkbox" name="roll_serialize" id="roll_serialize" value="yes">Checked this for class roll serialize.</label>
                            </div>
