    ...
    <div class="panel col-sm-12" style="margin-top: 15px; margin-bottom: 15px;">
        ...
        <div class="panel-body col-md-12" style="border:1px solid #ddd;">
            <div class="page-header">
                <h1 class="text-center text-temp">New Advice List</h1>
            </div>
                ...
                <table id="advice_tbl" class="table table-bordered table-hover table-striped">
                    ...
                    @foreach($unseen_advices as $advice)
                        <tr>
                            ...
                            <td>{{ $advice->school->user->name }}</td>
                            <td>{{ $advice->school->user->email }}</td>
                            <td>{{ $advice->school->website }}</td>
