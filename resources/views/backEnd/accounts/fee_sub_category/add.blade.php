...
@section('mainTitle', 'ফি সাব ক্যাটাগরি পরিচালন')
...
@section('content')
  ...
  <div class="row">
    <div class="col-md-6">
      <h2 class="text-center text-temp">সাব ক্যাটাগরি পরিচালনা করুন</h2>
    </div>
    <div class="col-md-6">
      <h2 class="text-center text-temp">সাব ক্যাটাগরি যোগ করুন</h2>
    </div>
    <div class="col-md-12">
                  ...
                  @foreach($fee_sub_categories as $fee_sub_category)
                      <tr>
                          ...
                          <td class="text-center">
                            <a href="{{ route('fee_sub_category_edit', $fee_sub_category->id) }}" title="পরিবর্তন করুন"> <button type="button" class="btn btn-info btn-sm" style="margin: 5px;"><i class="fa fa-pencil-square-o"></i></button> </a>
                            <form class="" action="{{ route('fee_sub_category_delete') }}" method="post">
                              @csrf
                              @method('delete')
                              <input type="hidden" name="id" value="{{ $fee_sub_category->id }}">
                              <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('আপনি কি সাব-ক্যাটাগরি মুছে ফেলতে চান ?')" title="মুছে ফেলুন"><i class="fa fa-trash-o"></i></button>
                            </form>
                          </td>
                      </tr>
                  @endforeach
                ...
                <div class="row">
                  <div class="col-sm-6">
                      <div class="form-group">
                          ...
                          <div class="">
                              <input value="{{old('name')}}" type="text" name="name" class="form-control" placeholder="সাব ক্যাটাগরির নাম লিখুন">
                          </div>
                      </div>
                  </div>
                  <div class="col-sm-6">
