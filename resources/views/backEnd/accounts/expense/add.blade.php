...
@section('content')
  <div class="row">
    <div class="col-md-6" style="padding: 15px;">
      <h2 class="text-center text-temp">Add Expense</h2>
    </div>
    <div class="col-md-6" style="padding: 15px;">
      <h2 class="text-center text-temp">Print Voucher</h2>
    </div>
    <div class="col-md-12">
        ...
        <div class="panel-body">
            <form action="{{ route('expense_store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                      <div class="form-group">
                          <label class="" for="received_by">Received By <span class="star">*</span></label>
                          <div class="">
                  ...
                  <div class="col-sm-12">
                      <div class="form-group">
                          <label class="" for="fund_id">Description</label>
                          <div class="">
      ...
      <div id="vouchercontents" class="panel col-sm-12" style="width: 100%; position: relative; height: 100%;">
        <div id="voucher" class="row vouchar1" style=" height: 50%;">
          ...
          <div class="col-md-6 text-left" style="padding-bottom: 15px; display:inline-block; float:left;">
            Serial: {{ $expense_view->serial }}
          </div>
          <div class="col-md-6 text-right" style="padding-bottom: 15px;">
            Date: {{ $expense_view->payment_date }}
          </div>
          <div class="col-md-12">
            <div class="row">
