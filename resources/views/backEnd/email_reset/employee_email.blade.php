...
<div class="panel col-md-12" style="margin-top: 15px; margin-bottom: 15px;">
    <div class="page-header">
        <h1 class="text-center text-temp">Employee Email Reset</h1>
    </div>
    ...
    <div class="col-md-12" style="border: 1px solid #ddd;">
        ...
        <div class="row col-md-8 col-md-offset-2">
            <form action="{{route('employee_email_reset')}}" method="post">
                {{csrf_field()}}
    ...
    <div class="col-sm-12">
        ...
        <div class="row">
            <div class="panel-body" style="margin-top: 10px;">
                <form action="{{route('employee_email_generate')}}" method="post" enctype="multipart/form-data" target="_blank">
                    {{csrf_field()}}
                    @php($i=1)
                    <div class="row">
                        <div class="col-sm-12">
