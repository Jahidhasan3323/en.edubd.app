...
@section('content')
    <div class="panel col-sm-12" style="margin-top: 15px; margin-bottom: 15px;">
        <div class="page-header">
            <h1 class="text-center text-temp">Student Email Reset</h1>
        </div>
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <form action="{{route('student_email_reset')}}" method="post">
                    {{csrf_field()}}
        ...
        <div class="row">
            <div class="panel-body" style="margin-top: 10px;">
                <form action="{{route('student_email_generate')}}" method="post" enctype="multipart/form-data" target="_blank">
                    {{csrf_field()}}
                    @php($i=1)
            <div class="row">
               <div class="col-sm-12">
