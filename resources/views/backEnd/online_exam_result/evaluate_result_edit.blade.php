      ...
      <form class="form-inline" action="{{url('online-exam/evaluate')}}" method="post" enctype="multipart/form-data">
        ...
        @foreach($results as $result)
          ...
          <p>
            ...
            <input type="text" name="mark_{{$result->id}}" class="form-control" data-validation="required length number" data-validation-length="max10" data-validation-allowing="float" value="{{ $result->mark }}">
          </p>
          <?php $i++ ?>
        @endforeach
