...
@section('mainTitle', 'Monthly Attendance List (Blank)')
...
@endif
    <div class="panel col-sm-12" style="margin-top: 15px; margin-bottom: 15px;">
        <div class="page-header">
            <h1 class="text-center text-temp">Monthly Attendance Sheet (Blank)</h1>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group {{$errors->has('user_type') ? 'has-error' : ''}}">
                            <label for="user_type">Student/Employee<font color="red" size="4">*</font></label>
                            <div class="user_type">
                                <select name="user_type" id="user_type" class="form-control" onchange="display_required_field();">
                                    <option value="">Select Student/Employee</option>
