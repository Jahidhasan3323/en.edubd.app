...
class AdmitCardController extends Controller
{
    ...
    public function create()
    {
        ...
        $units = $this->getUnits();
        return view('backEnd.admitCard.create',compact('classes', 'years', 'exams','groups','units'));
    }

    /**
     * Display the specified resource.
     *
     * @param  show search student admit cart
     * @return \Illuminate\Http\Response
     */
    public function show(Request $request)
    {
       ...
       return view('backEnd.admitCard.admit_card_show',compact('students','school','request','exam'));
   }
