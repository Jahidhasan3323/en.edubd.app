...
@section('mainTitle', 'Exam Seat Plan')
...
@section('content')
    <div class="panel col-sm-12" style="margin-top: 15px; margin-bottom: 15px;">
        <div class="page-header">
            <h1 class="text-center text-temp">Exam Seat Plan</h1>
        </div>
        ...
        <div class="panel-body">
            <form id="result_from" action="{{url('/exam-seat-plan/show')}}" method="get">
                {{csrf_field()}}
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label class="" for="student_id">Student/Students ID No. ( Example: 880000000000001,880000000000002 )</label>
                            <div class="">
