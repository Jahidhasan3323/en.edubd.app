                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group {{$errors->has('question') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('question',$question->question)}}" class="form-control" type="text" name="question" id="question" placeholder="প্রস্ন" data-validation="required length" data-validation-length="max100">
                            </div>
                    ...
                    <div class="col-md-6">
                          <div class="form-group {{$errors->has('answer') ? 'has-error' : ''}}">
                              ...
                              <div class="">
                                  <input value="{{old('answer',$question->answer)}}" class="form-control" type="text" name="answer" id="answer" placeholder="উত্তর" data-validation="required length number" data-validation-length="max10">
                              </div>
                ...
                <?php $i=1; ?>
                    <div class="col-md-6">
                        <div class="form-group {{$errors->has('option') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{old('option',$option->option)}}" class="form-control" type="text" name="option[]" id="option" placeholder="অপশন" data-validation="length" data-validation-length="max100">
                            </div>
