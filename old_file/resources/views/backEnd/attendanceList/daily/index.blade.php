       ...
       <div class="col-12">
           <div class="row1">
             ...
             <div class="col-8 school-info">
               ...
               @endif
               <p>{{isset($exam->name)?'অংশগ্রহণকারী':''}}Student Attendance</p>

               <p>Class : {{$students[0]->masterClass->name}}, Section : {{$data['section']}}, Group : {{$data['group']}} & Shift : {{$data['shift']}}</p>
               @if(!isset($exam->name))
               <p>Date : __/__/____</p>
               @endif
