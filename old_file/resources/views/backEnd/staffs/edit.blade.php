...
<br>
        ...
        <div class="page-header">
            <h1 class="text-center text-temp">Edit Academic Information</h1>
        </div>
        <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group {{$errors->has('salary') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{$staff->salary}}" class="form-control" type="number" name="salary" id="salary" placeholder="Monthly Salary">
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group {{$errors->has('joining_date') ? 'has-error' : ''}}">
                            <label for="joining_date">Joining Date<span class="star">*</span></label>
                            <div class="">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group {{$errors->has('index_no') ? 'has-error' : ''}}">
                            ...
                            <div class="">
                                <input value="{{$staff->index_no}}" class="form-control" type="number" name="index_no" id="index_no" placeholder="Index Number">
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group {{$errors->has('date_of_mpo') ? 'has-error' : ''}}">
                            <label for="date_of_mpo">Date of MPO Registration</label>
                            <div class="">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group {{$errors->has('email') ? 'has-error' : ''}}">
                        ...
                        <div class="">
                            <input value="{{$staff->user->email}}" class="form-control" type="email" name="email" id="email" placeholder="Employee Email">
                        </div>
                        @if ($errors->has('email'))
                            <span class="help-block">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group {{$errors->has('mobile') ? 'has-error' : ''}}">
                        ...
                        <div class="">
                            <input value="{{$staff->user->mobile}}" class="form-control" type="number" name="mobile" id="mobile" placeholder="Mobile number">
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group {{$errors->has('last_org_address') ? 'has-error' : ''}}">
                        <label for="last_org_address">Company address </label>
                        <div class="">
        ...
        <div class="page-header">
            <h1 class="text-center text-temp">Edit present address information</h1>
        </div>
        <div class="panel-body">
           <div class="row">
               <div class="col-sm-4">
           ...
           <div class="row">
               ...
               <div class="col-sm-4">
                   <div class="form-group {{$errors->has('pre_poff') ? 'has-error' : ''}}">
                       ...
                       <div>
                           <input value="{{$staff->pre_poff}}" type="text" class="form-control" name="pre_poff" id="pre_poff" placeholder="Post office">
                       </div>
           ...
           <div class="row">
               <div class="col-sm-4">
                   <div class="form-group {{$errors->has('pre_subd') ? 'has-error' : ''}}">
                       ...
                       <div>
                           <input value="{{$staff->pre_subd}}" type="text" class="form-control" name="pre_subd" id="pre_subd" placeholder="Sub District / Thana">
                       </div>
               ...
               <div class="col-sm-4">
                   <div class="form-group {{$errors->has('pre_district') ? 'has-error' : ''}}">
                       ...
                       <div>
                           <input value="{{$staff->pre_district}}" type="text" class="form-control" name="pre_district" id="pre_district" placeholder="District">
                       </div>
               ...
               <div class="col-sm-4">
                   <div class="form-group {{$errors->has('pre_postc') ? 'has-error' : ''}}">
                       ...
                       <div>
                           <input value="{{$staff->pre_postc}}" type="number" class="form-control" name="pre_postc" id="pre_postc" placeholder="Post Code">
                       </div>
        ...
        <div class="page-header">
            <h1 class="text-center text-temp">Edit Permanent address</h1>
        </div>
        <div class="panel-body">
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group {{$errors->has('per_address') ? 'has-error' : ''}}">
                        ...
                        <div>
                            <input value="{{$staff->per_address}}" type="text" class="form-control" name="per_address" id="per_address" placeholder="persent address">
                        </div>
                ...
                <div class="col-sm-4">
                    <div class="form-group {{$errors->has('per_h_no') ? 'has-error' : ''}}">
                        ...
                        <div>
                            <input value="{{$staff->per_h_no}}" type="text" class="form-control" name="per_h_no" id="per_h_no" placeholder="House / Holding Number">
                        </div>
                ...
                <div class="col-sm-4">
                    <div class="form-group {{$errors->has('per_ro_no') ? 'has-error' : ''}}">
                        ...
                        <div>
                            <input value="{{$staff->per_ro_no}}" type="text" class="form-control" name="per_ro_no" id="per_ro_no" placeholder="Road Number">
                        </div>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group {{$errors->has('per_vpm') ? 'has-error' : ''}}">
                        ...
                        <div>
                            <input value="{{$staff->per_vpm}}" type="text" class="form-control" name="per_vpm" id="per_vpm" placeholder="Village / Para / Mahalla">
                        </div>
                ...
                <div class="col-sm-4">
                    <div class="form-group {{$errors->has('per_poff') ? 'has-error' : ''}}">
                        ...
                        <div>
                            <input value="{{$staff->per_poff}}" type="text" class="form-control" name="per_poff" id="per_poff" placeholder="Post office">
                        </div>
                ...
                <div class="col-sm-4">
                    <div class="form-group {{$errors->has('per_unim') ? 'has-error' : ''}}">
                        ...
                        <div>
                            <input value="{{$staff->per_unim}}" type="text" class="form-control" name="per_unim" id="per_unim" placeholder="Union / Municipality">
                        </div>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group {{$errors->has('per_subd') ? 'has-error' : ''}}">
                        ...
                        <div>
                            <input value="{{$staff->per_subd}}" type="text" class="form-control" name="per_subd" id="per_subd" placeholder="Sub District / Thana">
                        </div>
                ...
                <div class="col-sm-4">
                    <div class="form-group {{$errors->has('per_district') ? 'has-error' : ''}}">
                        ...
                        <div>
                            <input value="{{$staff->per_district}}" type="text" class="form-control" name="per_district" id="per_district" placeholder="District">
                        </div>
                ...
                <div class="col-sm-4">
                    <div class="form-group {{$errors->has('per_postc') ? 'has-error' : ''}}">
                        ...
                        <div>
                            <input value="{{$staff->per_postc}}" type="number" class="form-control" name="per_postc" id="per_postc" placeholder="Post Code">
                        </div>
        ...
        <div class="page-header">
            <h1 class="text-center text-temp">Edit Family Information information</h1>
        </div>
        <div class="panel-body">
            <!-- father information -->
                   <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group {{$errors->has('f_career') ? 'has-error' : ''}}">
                                ...
                                <div class="">
                                    <input value="{{$staff->f_career}}" class="form-control" type="text" name="f_career" id="f_career" placeholder="Father Career">
                                </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group {{$errors->has('f_m_income') ? 'has-error' : ''}}">
                                ...
                                <div class="">
                                    <input value="{{$staff->f_m_income}}" class="form-control" type="number" name="f_m_income" id="f_m_income" placeholder="Father Monthly Income">
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 {{$errors->has('f_mobile_no') ? 'has-error' : ''}}">
                            <div class="form-group">
                                ...
                                <div class="">
                                    <input value="{{$staff->f_mobile_no}}" class="form-control" type="number" name="f_mobile_no" id="f_mobile_no" placeholder=" Father Mobile No.">
                                </div>
                            </div>
                   ...
                   <div class="row">
                       ...
                       <div class="col-sm-4">
                           <div class="form-group {{$errors->has('f_nid') ? 'has-error' : ''}}">
                               ...
                               <div class="">
                                   <input value="{{$staff->m_m_income}}" class="form-control" type="number" name="m_m_income" id="m_m_income" placeholder="Mother Monthly Income">
                               </div>
                   ...
                   <div class="row">
                       <div class="col-sm-6 {{$errors->has('m_mobile_no') ? 'has-error' : ''}}">
                           <div class="form-group">
                               ...
                               <div class="">
                                   <input value="{{$staff->m_mobile_no}}" class="form-control" type="number" name="m_mobile_no" id="m_mobile_no" placeholder=" Mother Mobile No.">
                               </div>
                           </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group {{$errors->has('h_w_mobile_no') ? 'has-error' : ''}}">
                        <label class="" for="h_w_mobile_no">Phone Number</label>
                        <div class="">
                            <input value="{{$staff->h_w_mobile_no}}" class="form-control" type="number" name="h_w_mobile_no" id="h_w_mobile_no" placeholder="Mobile Number">
                        </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group {{$errors->has('photo') ? 'has-error' : ''}}">
                        <label class="" for="photo">Photo Upload </label>
                        <div class="">
