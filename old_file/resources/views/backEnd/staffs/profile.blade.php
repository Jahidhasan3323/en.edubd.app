...
@section('profile')
    <a href="{{url('/editTeacherProfile')}}" class="btn btn-danger square-btn-adjust">Edit Profile</a>
@endsection
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered">
                            <tr><th width="50%">Name </th><td>{{$staff->user->name}}</td></tr>
                            ...
                            <tr><th>Index No.ং</th><td>{{$staff->index_no}}</td></tr>
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered">
                            ...
                            <tr><th>Company address </th><td>{{$staff->last_org_address}}</td></tr>
