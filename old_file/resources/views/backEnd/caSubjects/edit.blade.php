                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group {{$errors->has('pass_mark') ? 'has-error' : ''}}">
                            <label class="control-label" for="pass_mark">Total pass marks</label>
                            <div class="">
                                <input value="{{old('pass_mark',$subject->pass_mark)}}" class="form-control" type="text" name="pass_mark" id="pass_mark" placeholder="Pass marks">
                            </div>
